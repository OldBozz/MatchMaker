...
CREATE TABLE `clubplayer` (
  ...
  PRIMARY KEY (`ClubsId`,`PlayersId`),
  KEY `IX_ClubPlayer_PlayersId` (`PlayersId`),
  CONSTRAINT `FK_ClubPlayer_Clubs_ClubsId` FOREIGN KEY (`ClubsId`) REFERENCES `clubs` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_ClubPlayer_Players_PlayersId` FOREIGN KEY (`PlayersId`) REFERENCES `players` (`Id`) ON DELETE CASCADE
...
INSERT INTO `clubplayer` VALUES (4,20);
...
-- Dump completed on 2023-07-27 14:14:54
